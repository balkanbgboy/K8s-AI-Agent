...
4. **Set your Gemini API key**
   ...
   Open `agent.py` and replace the `google_api_key` value, or set it as an environment variable:
...
**create_deployment**
```
name: <name>, image: <image>, replicas: <n>
```

**create_service**
```
name: <name>, port: <port>, type: ClusterIP|NodePort|LoadBalancer
```
